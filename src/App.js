...
export default function App() {
  ...
  return (
    <Canvas shadows camera={{ position: [15, 40, 75], fov: 25 }}>
      <Environment files="/snowy_forest_path_01_4k.hdr" ground={{ height: 20, radius: 40, scale: 220 }} />
      <Model position={[0, 0, 3]} scale={7.8} animationName={isTalking ? "talk" : "idle"} />
